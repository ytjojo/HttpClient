...
public class FcPermissions {
    ...
    public static void requestPermissions(final Object object, String rationale,
                ...
                AlertDialog dialog = new AlertDialog.Builder(activity)
                        ...
                        .setNegativeButton(negativeButton, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (object instanceof PermissionsCallback) {
                                    ((PermissionsCallback) object).onPermissionsDenied(requestCode, Arrays.asList(perms));
                                }
        ...
        if (object instanceof PermissionsCallback) {
            ((PermissionsCallback) object).onPermissionsGranted(requestCode, Arrays.asList(perms));
        }
    }
    ...
    public static void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        if (!granted.isEmpty()) {
            // Notify callbacks
            if (object instanceof PermissionsCallback) {
                ((PermissionsCallback) object).onPermissionsGranted(requestCode, granted);
            }
        }
        ...
        if (!denied.isEmpty()) {
            if (object instanceof PermissionsCallback) {
                ((PermissionsCallback) object).onPermissionsDenied(requestCode, denied);
            }
        }
    }
