...
public abstract class Uri implements Parcelable, Comparable<Uri> {
    ...
    */
    ...
    public boolean isPathPrefixMatch(Uri prefix) {
        if (!equals(getScheme(), prefix.getScheme())) return false;
        if (!equals(getAuthority(), prefix.getAuthority())) return false;
        ...
        for (int i = 0; i < prefixSize; i++) {
            if (!equals(seg.get(i), prefixSeg.get(i))) {
                return false;
            }
        }
    ...
    public Uri.Builder replaceQueryParameter(String key,String value){
        Set<String> names= this.getQueryParameterNames();
        if(names==null||names.isEmpty()){
            return this.buildUpon().appendQueryParameter(key,value);
        }
        ...
        for(String name:names){
            ...
            querys.put(name,this.getQueryParameter(name));
        }
        Uri.Builder builder = this.buildUpon().clearQuery();
