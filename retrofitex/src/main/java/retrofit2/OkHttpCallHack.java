...
final class OkHttpCallHack<T> implements Call<T> {
  ...
  @Override public OkHttpCallHack<T> clone() {
    return new OkHttpCallHack<>(serviceMethod, args);
  }
  ...
  @Override public void enqueue(final Callback<T> callback) {
    ...
    call.enqueue(new okhttp3.Callback() {
      ...
      @Override public void onFailure(okhttp3.Call call, IOException e) {
        try {
          callback.onFailure(OkHttpCallHack.this, e);
        } catch (Throwable t) {
          t.printStackTrace();
        }
      }
      ...
      private void callSuccess(Response<T> response) {
        try {
          callback.onResponse(OkHttpCallHack.this, response);
        } catch (Throwable t) {
          t.printStackTrace();
        }
      }
